...
def enrich_with_llm(extracted: Dict[str, Any], user_token: Optional[str] = None, sector: str = "General Data Privacy", framework: str = "django") -> Dict[str, Any]:
    """
    Sends compact JSON to LLM and merges enriched response.
    """
    ...
    if not user_token:
        return {
            "error": "LLM enrichment skipped: No user token provided.",
            "raw_response": ""
        }
